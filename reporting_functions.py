...
def get_employee_attendance_trend(employee_id, year):
    ...
    return execute_query("""
        ...
        ORDER BY date
    """, (employee_id, str(year)), fetch='all')
...
def predict_leave_demand(leave_type_id, months=3):
    ...
    """, (leave_type_id,), fetch='one')["total_days"]
...
def update_daily_attendance_summary():
    ...
    for record in attendance_records:
        ...
        data_to_insert.append((employee_id, date, total_hours_worked, is_absent, is_late, is_early_departure))
...
def update_annual_leave_summary():
    ...
    leave_balances = execute_query("SELECT * FROM employee_leave_balance", fetch='all')
    ...
    for balance in leave_balances:
        ...
        update_data.append((employee_id, leave_type_id, year, allocated_days, used_days, remaining_days))
